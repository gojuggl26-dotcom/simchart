...
指示書 §4 の因子構造のうち「全資産で共有される実現」を 1 か所で生成する:
...
def _common_jumps(
    ...
    **資産側が固有成分で残すのと同じ規約で残す** (S12 の λ0=5 → 実効 ~4.2/年 と
    ...
    サイズ分布は資産側と同一の Kou (同じ η — 「市場ニュースだから大きい」等の
